...
// Only the ~7 cards currently in view ever fetch their image — the other
// ~100 keep just a data-src until the carousel rotates them into range —
// and the whole thing waits to build until the section nears the viewport,
// so none of this competes with the Hero/critical assets on first load.
